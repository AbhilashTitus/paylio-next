            ...
            <section className="pb-24 px-6">
                ...
                >
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl not-prose mt-4 border border-slate-100">
                        ...
                        <p className="text-sm mt-1">Regd. Office Address</p>
                        <p className="text-sm mt-1">Plumeria, 17 CPR Layout Road, Haralur Main Rd, opp. OZONE EVERGREENS, PWD Quarters,</p>
                        <p className="text-sm">Apartment, HSR Layout, Bengaluru, Karnataka 560102</p>
